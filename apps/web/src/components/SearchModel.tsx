...
const SearchModel = (props: {
  open: boolean;
  value: string;
  queryResults: QueryDocumentSnapshot<DocumentData>[] | undefined;
  handleToggle: () => void;
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8">
              ...
              <div>
                <div className="mt-3 text-center">
                  ...
                  <div className="mt-2">
                    ...
                    >
                      <div className="-space-y-px w-full rounded-md shadow-sm mr-3">
            ...
            {queryResults &&
              queryResults.map((doc_, idx) => {
                return <SearchResultCard data={doc_.data()} key={`${idx}`} />;
              })}
